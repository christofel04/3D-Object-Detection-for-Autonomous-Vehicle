...
class KittiDataset(DatasetTemplate):
    ...
    def get_lidar(self, idx):
        ...
        #print("Path of LiDAR file is : " + str( lidar_file ))
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    try :
        ...
        print( "Cannot processed KITTI test dataset because error : {}".format( e ))
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            class_names=["car", "pedestrian" , "motorcycle" ] , # ['Car', 'Pedestrian', 'Cyclist'],
            data_path= Path("/home/ofel04/Open_LiDAR_Dataset_in_KITTI_Format/"), # ROOT_DIR / 'data' / 'kitti',
            save_path= Path("/home/ofel04/Open_LiDAR_Dataset_in_KITTI_Format/" ) #ROOT_DIR / 'data' / 'kitti'
        )
